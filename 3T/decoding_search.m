function decoding_search(sub,analysis_all,rois,shift,decode,con)
...
%     mask=get_filenames_afni([datafolder sub '/' sub '.' analysis '.results/mask_' roi '*+orig.HEAD']);
    ...
    test=[con '_' roi];
    cfg.searchlight.radius = 3; % use searchlight of radius 4 (by default in voxels), see more details below
