...
3dDeconvolve -input ${pb}.$subj.r*.scale+orig.HEAD             \
    ...
    -stim_file 9 ppi/p6.$sub.$seed.01.FearPleaVis.rall.PPI.1D                   \
    -stim_label 9 PPI.FearPleaVis                                             \
    -stim_file 10 ppi/p6.$sub.$seed.02.FearPleaInv.rall.PPI.1D                   \
    -stim_label 10 PPI.FearPleaInv                                             \
    -stim_file 11 ppi/p6.$sub.$seed.03.FearUnpleaVis.rall.PPI.1D                   \
    -stim_label 11 PPI.FearUnpleaVis                                             \
    -stim_file 12 ppi/p6.$sub.$seed.04.FearUnpleaInv.rall.PPI.1D                   \
    -stim_label 12 PPI.FearUnpleaInv                                             \
    -stim_file 13 ppi/p6.$sub.$seed.05.HappPleaVis.rall.PPI.1D                   \
    -stim_label 13 PPI.HappPleaVis                                            \
    -stim_file 14 ppi/p6.$sub.$seed.06.HappPleaInv.rall.PPI.1D                   \
    -stim_label 14 PPI.HappPleaInv                                             \
    -stim_file 15 ppi/p6.$sub.$seed.07.HappUnpleaVis.rall.PPI.1D                   \
    -stim_label 15 PPI.HappUnpleaVis                                             \
    -stim_file 16 ppi/p6.$sub.$seed.08.HappUnpleaInv.rall.PPI.1D                   \
    -stim_label 16 PPI.HappUnpleaInv                                            \
    -stim_file 17 ppi/ppi.seed.$sub.$seed.1D                                  \
