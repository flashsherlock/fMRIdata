...
3dDeconvolve -input ${pb}.${subj}.r*.scale+orig.HEAD           \
    ...
    -polort 3                                                  \
    -num_stimts 8                                              \
    -stim_times 1 ../behavior/FearPleaVis_11s.txt 'TENT(0,14,8)'          \
    -stim_label 1 FearPleaVis                                          \
    -stim_times 2 ../behavior/FearPleaInv_11s.txt 'TENT(0,14,8)'          \
    -stim_label 2 FearPleaInv                                          \
    -stim_times 3 ../behavior/FearUnpleaVis_11s.txt 'TENT(0,14,8)'          \
    -stim_label 3 FearUnpleaVis                                          \
    -stim_times 4 ../behavior/FearUnpleaInv_11s.txt 'TENT(0,14,8)'          \
    -stim_label 4 FearUnpleaInv                                          \
    -stim_times 5 ../behavior/HappPleaVis_11s.txt 'TENT(0,14,8)'          \
    -stim_label 5 HappPleaVis                                          \
    -stim_times 6 ../behavior/HappPleaInv_11s.txt 'TENT(0,14,8)'          \
    -stim_label 6 HappPleaInv                                          \
    -stim_times 7 ../behavior/HappUnpleaVis_11s.txt 'TENT(0,14,8)'          \
    -stim_label 7 HappUnpleaVis                                          \
    -stim_times 8 ../behavior/HappUnpleaInv_11s.txt 'TENT(0,14,8)'          \
