...
3dDeconvolve -input ${pb}.${subj}.r*.scale+orig.HEAD           \
    ...
    -polort 3                                                  \
    -num_stimts 10                                              \
    -stim_times 1 ../behavior/FearPleaVis.txt 'TENT(0,14,8)'          \
    -stim_label 1 FearPleaVis                                          \
    -stim_times 2 ../behavior/FearPleaInv.txt 'TENT(0,14,8)'          \
    -stim_label 2 FearPleaInv                                          \
    -stim_times 3 ../behavior/FearUnpleaVis.txt 'TENT(0,14,8)'          \
    -stim_label 3 FearUnpleaVis                                          \
    -stim_times 4 ../behavior/FearUnpleaInv.txt 'TENT(0,14,8)'          \
    -stim_label 4 FearUnpleaInv                                          \
    -stim_times 5 ../behavior/HappPleaVis.txt 'TENT(0,14,8)'          \
    -stim_label 5 HappPleaVis                                          \
    -stim_times 6 ../behavior/HappPleaInv.txt 'TENT(0,14,8)'          \
    -stim_label 6 HappPleaInv                                          \
    -stim_times 7 ../behavior/HappUnpleaVis.txt 'TENT(0,14,8)'          \
    -stim_label 7 HappUnpleaVis                                          \
    -stim_times 8 ../behavior/HappUnpleaInv.txt 'TENT(0,14,8)'          \
    -stim_label 8 HappUnpleaInv                                          \
    -stim_times 9 ../behavior/fix.txt 'BLOCK(1,1)'      \
    -stim_label 9 fixation                                \
    -stim_times 10 ../behavior/fixoff.txt 'BLOCK(0.5,1)'      \
    -stim_label 10 fixoff                                \
    -jobs 28                                                   \
