...
if [ "$1" = "whole" ]; then
      ...
      out=fusiformCA
elif [ "$1" = "fusiformAAL" ]; then
      mask=group/mask/FusiformAAL+tlrc
      out=fusiformAAL
elif [ "$1" = "FFVAAL" ]; then
      mask=group/mask/FFVAAL+tlrc
      out=FFVAAL
elif [ "$1" = "FFVAAL05" ]; then
      mask=group/mask/FFVAAL05+tlrc
      out=FFVAAL05
elif [ "$1" = "FFVAAL01" ]; then
      mask=group/mask/FFVAAL01+tlrc
      out=FFVAAL01
elif [ "$1" = "FFVAAL001" ]; then
      mask=group/mask/FFVAAL001+tlrc
      out=FFVAAL001
elif [ "$1" = "A37mlv" ]; then
