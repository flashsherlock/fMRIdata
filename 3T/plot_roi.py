...
gl.smooth(1)
# Open overlay
namelist = ['OFC6mm', 'Pir_new.draw', 'Amy8_align.freesurfer']
# get length of namelist
namelen=len(namelist)
# for n from 1 to length of namelist
gl.overlaycloseall()
...
gl.cameradistance(1)
# gl.cameradistance(2)
gl.cutout(0.5,0.42,0.33,0,1,1)
gl.shaderquality1to10(10)
gl.shadermatcap('01_fuzzy')
gl.azimuthelevation(95, 20)
# gl.azimuthelevation(55, 25)
# Save the image 
gl.savebmp(data_dir + '../plotmask/ROIsrender.png')