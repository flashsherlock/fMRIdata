function practice_odor(offcenter_x, offcenter_y)
% ROIsLocalizer(offcenter_x, offcenter_y), [LO, FFA, and EBA]
% Scan = 396s, TR = 3s, 132TR
if nargin < 2
    offcenter_x=0; offcenter_y=-100;
end
% repeat
times=2;% even number
% scale
...
datafile=sprintf('Data%s%s_practice%d%s.mat',filesep,subject,runnum,datestr(now,30));
