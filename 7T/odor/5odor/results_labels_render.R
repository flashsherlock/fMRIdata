...
path <- "/Volumes/OlfDisk2/gf/7T_odor/"
# mp<- c("roi_VIvaodor_l1_label_6")
mp <- c("roi_ARodor_l1_odoronly_6")
analysis <- c("pabiode")
# subs no 12 15 30
...
roi <- c('superAmy_at165','BaLaAmy_at165','APC_new_at165','PPC_at165','V1','V2','V3',"precentral")
roiname <- c("Super","Deep","APC","PPC","V1","V2","V3","Prec")
