...
mp <- c("roi_ARodor_l1_odor5nova_-6-36")
analysis <- c("pabiode")
# subs no 12 15 30
...
roi <- c('superAmy_at165','BaLaAmy_at165','APC_new_at165','PPC_at165','V1','V2','V3')
roiname <- c("Super","Deep","APC","PPC","V1","V2","V3")
