...
3dDeconvolve -input pb05.${subj}.r*.volreg+orig.HEAD                \
    ...
    -stim_label 7 int                                               \
    -stim_times_AM1 8 ../behavior/odor_va.txt 'BLOCK(2,1)'          \
    -stim_label 8 odor_va                                           \
    -jobs 10                                                        \
...
3dSynthesize -cbucket cbucket.${subj}.${filedec}+orig -matrix X.nocensor.${filedec}.xmat.1D -select baseline val int odor_va -prefix NIfitts.${subj}.${filedec}
