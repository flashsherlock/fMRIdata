...
3dSynthesize -cbucket cbucket.${subj}.${filedec}+orig -matrix X.xmat.${filedec}.1D -select baseline val int odor_va odor_in -prefix NIfitts.${subj}.${filedec}
