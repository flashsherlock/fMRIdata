...
# set maskdec = at165 # at165 or align
...
# -nzmean ${data_tent}"[`seq -s , 1 43`44]" >! ../stats/Amy_${maskdec}_tent.txt

# # extract betas from blurred statas
# 3dROIstats -mask ../mask/Amy9_${maskdec}.freesurfer+orig \
# -nzmean ${data_beta}"[`seq -s , 1 3 9`10]" >! ../stats/Amy_${maskdec}_beta.txt

# foreach region (1 3 5 6 7 8 9 10 15)
#     3dROIstats -mask ../mask/Amy_${maskdec}${region}seg.freesurfer+orig \
#     -nzmean ${data_beta}"[`seq -s , 1 3 9`10]" >! ../stats/Amy_${maskdec}_seg{region}_beta.txt
# end
