...
3dttest++ -prefix group/${stats}_int                                       \
          ...
          -setA int                                               \
                ...
                12 "S17/S17.pabiode.results/${stats}.S17.pabiode.odorVI+tlrc[19]" \
                13 "S18/S18.pabiode.results/${stats}.S18.pabiode.odorVI+tlrc[19]" \
                14 "S19/S19.pabiode.results/${stats}.S19.pabiode.odorVI+tlrc[19]" \
                15 "S20/S20.pabiode.results/${stats}.S20.pabiode.odorVI+tlrc[19]" \
                16 "S21/S21.pabiode.results/${stats}.S21.pabiode.odorVI+tlrc[19]" \
                17 "S22/S22.pabiode.results/${stats}.S22.pabiode.odorVI+tlrc[19]" \
                18 "S23/S23.pabiode.results/${stats}.S23.pabiode.odorVI+tlrc[19]" \
                19 "S24/S24.pabiode.results/${stats}.S24.pabiode.odorVI+tlrc[19]" \
                20 "S25/S25.pabiode.results/${stats}.S25.pabiode.odorVI+tlrc[19]" \
                21 "S26/S26.pabiode.results/${stats}.S26.pabiode.odorVI+tlrc[19]" \
                22 "S27/S27.pabiode.results/${stats}.S27.pabiode.odorVI+tlrc[19]" \
                23 "S28/S28.pabiode.results/${stats}.S28.pabiode.odorVI+tlrc[19]" \
                24 "S29/S29.pabiode.results/${stats}.S29.pabiode.odorVI+tlrc[19]" \
                25 "S31/S31.pabiode.results/${stats}.S31.pabiode.odorVI+tlrc[19]" \
                26 "S32/S32.pabiode.results/${stats}.S32.pabiode.odorVI+tlrc[19]" \
                27 "S33/S33.pabiode.results/${stats}.S33.pabiode.odorVI+tlrc[19]" \
                28 "S34/S34.pabiode.results/${stats}.S34.pabiode.odorVI+tlrc[19]"