...
# run1 刺激完整 phase correction phy despike
        ...
        -dsets 12blip/pb04.S01_yyt.pabiode.r*.blip+orig.HEAD                                    \
        ...
        -blur_size 2.2                                                                          \
        -regress_stim_times                                                                     \
                behavior_${nrun}/lim.txt                                                        \
                behavior_${nrun}/tra.txt                                                        \
                behavior_${nrun}/car.txt                                                        \
                behavior_${nrun}/cit.txt                                                        \
                behavior_${nrun}/valence.txt                                                    \
                behavior_${nrun}/intensity.txt                                                  \
                behavior_${nrun}/odor_va.txt                                                    \
        -regress_stim_labels                                                                    \
