...
3dDeconvolve -input ${subj}_func_s+orig -num_stimts 15     \
 -jobs 2 \
 -polort 3 \
 ...
 -fitts fittsBLANK.${subj}.         \
 -bucket ${subj}.analysisBLANK.     \

 @auto_tlrc -apar ${subj}.str_al+tlrc. -input ${subj}.analysisBLANK.+orig.
