...
3dAllineate                                                                                         \
    -master ${sub}.pade.results/anat_final.${sub}.pade+orig                          \
    -1Dmatrix_apply ${sub}.pade.results/anatSS.${sub}_al_keep_mat.aff12.1D                \
...
# use a different directory to avoid conflicts with existing files in pade
set analysis=pade
