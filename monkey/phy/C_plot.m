...
%% 
fl = 'G:\rm035_麻醉\200807_testo4_rm035_1_01.plx';
[raw_freq, raw_n, raw_ts, raw_fn, raw_ad] = plx_ad(fl,'AI08'); % raw res data
%read spike time
post = 3;
[nspk, tspk] = plx_ts(fl, 'SPK63',0); % spike data
...
%     smoothfreq=freq;
 ...
 saveas(gcf,'rm035ana_0807_test04c1_63','pdf')
