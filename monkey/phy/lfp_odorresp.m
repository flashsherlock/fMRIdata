...
pic_dir=[data_dir 'pic/lfp_odorresp/'];
...
title([cur_roi '-odorresp' num2str(i) '-oddtrial'])
hold off
saveas(gcf, [pic_dir cur_roi '-odorresp' num2str(i) '-oddtrial', '.fig'], 'fig')
saveas(gcf, [pic_dir cur_roi '-odorresp' num2str(i) '-oddtrial', '.png'], 'png')
close all
end
%% select -1-4s
freq_range = [1.5 200];
...
plot(resavg.time,resavg.avg,'k','LineWidth',1.5)
set(gca,'xlim',time_range,'ytick',[]);
title([cur_roi '-odorresp' num2str(i)])
hold off
saveas(gcf, [pic_dir cur_roi '-odorresp' num2str(i), '.fig'], 'fig')
saveas(gcf, [pic_dir cur_roi '-odorresp' num2str(i), '.png'], 'png')
close all
end
...
plot(resavg.time,resavg.avg,'k','LineWidth',1.5)
set(gca,'xlim',time_range,'ytick',[]);
title([cur_roi '-odorresp' num2str(i) '-vs-air'])
hold off
saveas(gcf, [pic_dir cur_roi '-odorresp' num2str(i) '_vs_air', '.fig'], 'fig')
saveas(gcf, [pic_dir cur_roi '-odorresp' num2str(i) '_vs_air', '.png'], 'png')
close all
...
plot(resavg.time,resavg.avg,'k','LineWidth',1.5)
set(gca,'xlim',time_range,'ytick',[]);
title([cur_roi '-odorresp' num2str(i) '-vs-air-t'])
hold off
saveas(gcf, [pic_dir cur_roi '-odorresp' num2str(i) '_vs_air_t', '.fig'], 'fig')
saveas(gcf, [pic_dir cur_roi '-odorresp' num2str(i) '_vs_air_t', '.png'], 'png')
close all
...
plot(resavg.time,resavg.avg,'k','LineWidth',1.5)
set(gca,'xlim',time_range,'ytick',[]);
title([cur_roi '-odorresp' num2str(i) '-vs-air-tun'])
hold off
saveas(gcf, [pic_dir cur_roi '-odorresp' num2str(i) '_vs_air_tun', '.fig'], 'fig')
saveas(gcf, [pic_dir cur_roi '-odorresp' num2str(i) '_vs_air_tun', '.png'], 'png')
close all
...
plot(resavg.time,resavg.avg,'k','LineWidth',1.5)
set(gca,'xlim',time_range,'ytick',[]);
title([cur_roi '-odorresp-valence-t'])
hold off
saveas(gcf, [pic_dir cur_roi '-odorresp-valence-t', '.fig'], 'fig')
saveas(gcf, [pic_dir cur_roi '-odorresp-valence-t', '.png'], 'png')
close all
...
plot(resavg.time,resavg.avg,'k','LineWidth',1.5)
set(gca,'xlim',time_range,'ytick',[]);
title([cur_roi '-odorresp-valence-tun'])
hold off
saveas(gcf, [pic_dir cur_roi '-odorresp-valence-tun', '.fig'], 'fig')
saveas(gcf, [pic_dir cur_roi '-odorresp-valence-tun', '.png'], 'png')
close all
