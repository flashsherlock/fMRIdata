...
class_results <- function(power_data,tar,av_freq=TRUE,perm=FALSE){
  ...
  if (perm){
    ...
    odor_names <- unique(power_by_time$odor)
    power_by_time[,odor:=rep(sample(odor_names),each=length(unique(power_by_time$time))),by=.(roi)]
  }
