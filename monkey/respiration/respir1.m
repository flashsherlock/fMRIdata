function varargout = respir1(varargin)
% RESPIR1 MATLAB code for respir1.fig
%      RESPIR1, by itself, creates a new RESPIR1 or raises the existing
%      singleton*.
%
%      H = RESPIR1 returns the handle to a new RESPIR1 or the handle to
%      the existing singleton*.
%
%      RESPIR1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RESPIR1.M with the given input arguments.
%
%      RESPIR1('Property','Value',...) creates a new RESPIR1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before respir1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to respir1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help respir1

% Last Modified by GUIDE v2.5 24-Jul-2020 11:08:17
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @respir1_OpeningFcn, ...
                   'gui_OutputFcn',  @respir1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before respir1 is made visible.
function respir1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to respir1 (see VARARGIN)
...
% Choose default command line output for respir1
handles.output = hObject;
% Update handles structure
guidata(hObject, handles);
% UIWAIT makes respir1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);



% --- Outputs from this function are returned to the command line.
function varargout = respir1_OutputFcn(hObject, eventdata, handles)
