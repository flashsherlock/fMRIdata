function varargout = respir2(varargin)
% RESPIR2 MATLAB code for respir2.fig
%      RESPIR2, by itself, creates a new RESPIR2 or raises the existing
%      singleton*.
%
%      H = RESPIR2 returns the handle to a new RESPIR2 or the handle to
%      the existing singleton*.
%
%      RESPIR2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RESPIR2.M with the given input arguments.
%
%      RESPIR2('Property','Value',...) creates a new RESPIR2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before respir2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to respir2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help respir2

% Last Modified by GUIDE v2.5 31-Aug-2020 23:13:01
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @respir2_OpeningFcn, ...
                   'gui_OutputFcn',  @respir2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before respir2 is made visible.
function respir2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to respir2 (see VARARGIN)
...
% Choose default command line output for respir2
handles.output = hObject;
% Update handles structure
guidata(hObject, handles);
% UIWAIT makes respir2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);



% --- Outputs from this function are returned to the command line.
function varargout = respir2_OutputFcn(hObject, eventdata, handles)
